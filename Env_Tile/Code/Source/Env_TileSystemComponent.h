...
namespace Env_Tile
{
    ...
    protected:
        ////////////////////////////////////////////////////////////////////////
        // Env_TileRequestBus interface implementation
	...
	protected:		
		...
		int getSliceCount() override { return sliceList.size(); }
		////////////////////////////////////////////////////////////////////////
		...
		//Id of spawned entities
		AZStd::vector<AZ::EntityId> entityIds;

		//WEATHER
		//First builds trigger list and order
		...
		void PostActivate();
		//From Env_TileBus
		void preloadTriggersAtTime(int tod) override;
		WeatherUnit processNextTrigger() override;
